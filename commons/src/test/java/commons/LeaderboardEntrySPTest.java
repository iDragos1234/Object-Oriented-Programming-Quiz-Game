...
public class LeaderboardEntrySPTest {

    @Test
    public void checkConstructor() {
        var l = new LeaderboardEntrySP("fi", 1); //change this after issue #52 merged
    ...
    @Test
    void testGetName() {
        var l = new LeaderboardEntrySP("fi", 1);
    ...
    void testEquals() {
        var l = new LeaderboardEntrySP("fi", 1);
        var l2 = new LeaderboardEntrySP("fi", 1);
        assertEquals(l, l2);
    }
    ...
    void testNotEquals() {
        var l = new LeaderboardEntrySP("fi", 1);
        var l2 = new LeaderboardEntrySP("ha", 10);
    ...
    public void hasToString() {
        var actual = new LeaderboardEntrySP("fi", 1).toString();
